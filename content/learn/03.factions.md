...
**Kanka's [Organization entries](https://docs.kanka.io/en/latest/entries/organisations.html) are built for exactly this kind of relational faction design.** Each Organization tracks members, ranks, territory, and inter-faction connections as structured data — not just prose.
