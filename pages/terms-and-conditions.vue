<template>
  <BaseHero
      ...
      lead="Effective date: Jul 12, 2023" />


  <Section align="left">

    <h2 class="text-purple" id="agreement-to-terms"><a href="#agreement-to-terms">AGREEMENT TO TERMS</a></h2>
    ...
    <p>You agree that by accessing the Site, you have read, understood, and agree to be bound by all of these Terms and Conditions. We reserve the right, in our sole discretion, to make changes or modifications to these Terms and Conditions at any time and for any reason.</p>
    ...
    <h2 class="text-purple" id="user-representations"><a href="#user-representations">USER REPRESENTATIONS</a></h2>

    <p>By using the Site, you represent and warrant that:</p>

    <p>(1) you have the legal capacity and you agree to comply with these Terms and Conditions;</p>

    <p>(2) you will not use the Site for any illegal or unauthorized purpose;</p>

    <p>(3) your use of the Site will not violate any applicable law or regulation.</p>

    <h2 class="text-purple" id="user-registration"><a href="#user-registration">USER REGISTRATION</a></h2>

    <p>You will be required to register with the Site. You agree to keep your password confidential and will be responsible for all use of your account and password. We reserve the right to remove, reclaim, or change a username you select if we determine, in our sole discretion, that such username is inappropriate, obscene, or otherwise objectionable.</p>

    <h2 class="text-purple" id="prohibited-activities"><a href="#prohibited-activities">PROHIBITED ACTIVITIES</a></h2>
    ...
    <h2 class="text-purple" id="user-generated-contributions"><a href="#user-generated-contributions">USER GENERATED CONTRIBUTIONS</a></h2>
    ...
    <p>Public Contributions (but not Private Contributions) are viewable by other users of the Site. As such, any Public Contributions you transmit may be treated as non-confidential and non-proprietary by other users of the Site. When you create or make available any Contributions, you thereby represent and warrant that:</p>
    ...
    <h2 class="text-purple" id="site-management"><a href="#site-management">SITE MANAGEMENT</a></h2>

    <p>We reserve the right, but not the obligation, to:</p>

    <p>(1) monitor the Site for violations of these Terms and Conditions;</p>

    <p>(2) in our sole discretion and without limitation, refuse, restrict access to, limit the availability of, or disable (to the extent technologically feasible) any of your Contributions or any portion thereof;</p>

    <p>(3) otherwise manage the Site in a manner designed to protect our rights and to facilitate the proper functioning of the Site.</p>

    <h2 class="text-purple" id="copyright-infringements"><a href="#copyright-infringements">COPYRIGHT INFRINGEMENTS</a></h2>
    ...
    <h2 class="text-purple" id="term-and-termination"><a href="#term-and-termination">TERM AND TERMINATION</a></h2>
    ...
    <p>We may also periodically review and remove without prior warning accounts that have not been used for extended periods of time and have never created any contributions, or interacted with the website in any meaningful way.</p>

    <p>We may also periodically review and remove accounts that have not been used for extended periods of time and have had minor interactions with the website. These accounts will receive email notifications prior to deletion asking them to log onto the website in order to reset the timer on the account deletion.</p>

    <h2 class="text-purple" id="modifications-and-interruptions"><a href="#modifications-and-interruptions">MODIFICATIONS AND INTERRUPTIONS</a></h2>
    ...
    <p>We reserve the right to change, revise, update, suspend, discontinue, or otherwise modify the Site at any time or for any reason without notice. You agree that we have no liability whatsoever for any loss, damage, or inconvenience caused by your inability to access or use the Site during any downtime or discontinuance of the Site.</p>

    <h2 class="text-purple" id="user-data"><a href="#user-data">USER DATA</a></h2>
    ...
    <h2 class="text-purple" id="miscellaneous"><a href="#miscellaneous">MISCELLANEOUS</a></h2>
