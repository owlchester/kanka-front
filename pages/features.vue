<template>
  ...
  <Section>
    ...
    <div class="grid grid-cols-2 gap-8 mb-10 text-left">
      <div id="free" class="flex flex-col gap-3">
        <h3 class="">Free to use</h3>
        <p>
          Tired of having to pay for basic features like unlimited campaigns, having limits on the number of elements in a campaign, or not being able to control who sees what? We are too, which is why all core features of Kanka are absolutely free. We also have some <NuxtLink to="/pricing#paid-features">bonuses for our subscribers</NuxtLink> that are nice to have, though not essential. </p>
      </div>
      <div id="collaborative" class="flex flex-col gap-3">
        <h3>Collaborative</h3> 
        <p>
      ...
      <div id="modular" class="flex flex-col gap-3">
        <h3>Modular</h3>
        <p>
  ...
  <Section>
    ...
    <div class="grid grid-cols-2 gap-8 mb-10">
      <div id="relations">
        ...
        <p>
          <NuxtLink to="/premium">Premium campaigns</NuxtLink> have access to a visual explorer for the relations of an entity.
        </p>
      </div>
      <div>
        relation images
  ...
  <Section>
    <h2 class="text-purple bg-white top-0 sticky py-2" id="worldbuilding">
      Premium
      <a href="#premium" class="link-blue"><i class="fa-regular fa-arrow-up" aria-hidden="true"/></a>
    </h2>
    ...
    <div class="grid grid-cols-2 gap-8 mb-10">
      <div id="">
        ...
        <p>
          <NuxtLink to="/premium">
            See all premium features on our pricing page
          </NuxtLink>
        </p>
      </div>
