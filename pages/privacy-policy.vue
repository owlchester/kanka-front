<template>
  ...
  <Section align="left">
    ...
    <div>
      <h3 class="text-purple">Topics</h3>
    ...
    <div>
      <h2 class="text-purple mb-5" id="what-data-do-we-collect">What data do we collect and for how long?</h2>

      <p>Kanka collects the following data:</p>
      ...
      <p>We keep your profile information and content for the duration of your account.</p>
      <p>We keep your IP address for a maximum of 30 days.</p>
      <p class="mb-5">We keep other personally identifiable data we collect for a maximum of 3 months.</p>
    </div>

    <div>
      <h2 class="text-purple mb-5" id="how-do-we-collect">How do we collect your data?</h2>

      <p>You directly provide Kanka with most of the data we collect. We collect data and process data when you:</p>
    ...
    <div>
      <h2 class="text-purple mb-5" id="how-will-we-use">How will we use your data?</h2>

      <p>Kanka collects your data so that we can:</p>
      ...
      <ul class="ml-5 list-disc">
        ...
        <li>Use information you share with us, or that we collect to conduct surveys, testing, and troubleshooting to help us operate and improve Kanka.</li>
    ...
    <div>
      <h2 class="text-purple mb-5" id="how-do-we-store">How do we store your data?</h2>

      <p class="">We securely store your data on our servers which are with Hetzner in Germany and Amazon cloud Europe.</p>
    </div>

    <div>
      <h2 class="text-purple mb-5" id="cookies">Cookies</h2>

      <p class="">Cookies are text files placed on your computer to collect standard Internet log information and visitor behaviour information. When you visit our websites, we may collect information from you automatically through cookies or similar technology.</p>
    </div>

    <div>
      <h2 class="text-purple mb-5" id="what-kind-of-cookies">What kind of cookies do you use?</h2>
    ...
    <div>
      <h2 class="text-purple mb-5" id="why-cookies">What do you use these cookies for?</h2>

      <p>Cookies help us in different ways:</p>
      <ul class="ml-5 list-disc">
    ...
    <div>
      <h2 class="text-purple mb-5" id="privacy-policies-of-others">Privacy policies of other websites</h2>

      <p class="">The Kanka website contains links to other websites. Our privacy policy applies only to our website, so if you click on a link to another website, you should read their privacy policy.</p>
    </div>

    <div>
      <h2 class="text-purple mb-5" id="changes-to-our-policy">Changes to our privacy policy</h2>

      <p class="">We keep our privacy policy under regular review and publish all updates on this web page. This privacy policy was last updated on 12th of July 2023.</p>
    </div>

    <div>
      <h2 class="text-purple mb-5" id="how-to-contact-us">How to contact us</h2>

      <p>If you have any questions about Kanka’s privacy policy, the data we hold on you, or you would like to exercise one of your data protection rights, please do not hesitate to contact us.</p>

      <p>Email us at: <a href="mailto:hello@kanka.io">hello@kanka.io</a></p>
    </div>
  </Section>
</template>
